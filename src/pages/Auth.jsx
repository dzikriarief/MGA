      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <button
            type="button"
            disabled
            title="Google Sign-In akan segera hadir"
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium cursor-not-allowed opacity-50 mb-6"
